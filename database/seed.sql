...
VALUES
  ...
  (5, 'Banned User', 'banned@bscse.uiu.ac.bd', '$2y$10$SXPdsUJt/1M9FC7HzMnEyOMNsMXm3QkZsC9rlufA6hZ9JGWoEuADa', '0112230999', 'BSc in Computer Science and Engineering', '+8801844444444', 'This account has been banned for violating policies.', NULL, 'student', 1, 1, '2026-01-06 10:00:00', NULL, '2026-01-06 10:00:00', '2026-01-06 10:00:00'),
  (6, 'Inactive User', 'inactive@bscse.uiu.ac.bd', '$2y$10$SXPdsUJt/1M9FC7HzMnEyOMNsMXm3QkZsC9rlufA6hZ9JGWoEuADa', '0112230888', 'BSc in Computer Science and Engineering', '+8801855555555', 'Account deactivated.', NULL, 'student', 0, 0, '2026-01-07 10:00:00', NULL, '2026-01-07 10:00:00', '2026-01-07 10:00:00');

INSERT INTO categories (id, name, created_at, updated_at) VALUES
  (1, 'Electronics', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (2, 'Clothing', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (3, 'Documents', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (4, 'Accessories', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (5, 'Cards & ID', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (6, 'Keys', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (7, 'Books', '2026-01-01 09:05:00', '2026-01-01 09:05:00'),
  (8, 'Other', '2026-01-01 09:05:00', '2026-01-01 09:05:00');

INSERT INTO items
  (id, display_id, type, title, description, category_id, color, brand_model, location, specific_spot, lost_found_date, lost_found_time, current_location, status, posted_by, view_count, is_approved, admin_note, created_at, updated_at, deleted_at)
VALUES
  (1, 'LF-2026-0001', 'lost', 'Samsung Galaxy Phone', 'Lost a Samsung Galaxy phone with a matte black case. The lock screen has a photo from the UIU courtyard. It may have been left on a reading table after group study.', 1, 'Black', 'Samsung Galaxy S23', 'UIU Library 2nd Floor', 'Reading table near the east window', '2026-01-08', '15:20:00', NULL, 'active', 2, 34, 1, 'Approved for public listing.', '2026-01-08 15:45:00', '2026-01-08 15:45:00', NULL),
  (2, 'FF-2026-0001', 'found', 'UIU Student ID Card', 'Found a UIU student ID card after lunch. The card is safe and can be verified by name, student ID, and department before handover.', 5, 'White', NULL, 'UIU Cafeteria', 'Table beside the juice counter', '2026-01-09', '13:10:00', 'Cafeteria service counter', 'resolved', 3, 27, 1, 'Resolved after owner verification.', '2026-01-09 13:35:00', '2026-01-13 10:20:00', NULL),
  (3, 'FF-2026-0002', 'found', 'Black Wallet', 'Found a black leather wallet containing several cards and receipts. No cash amount will be disclosed publicly; owner must describe contents for verification.', 4, 'Black', 'Leather bi-fold wallet', 'Lecture Hall 302', 'Under the third row desk', '2026-01-10', '16:00:00', 'Department office front desk', 'claim_in_progress', 4, 42, 1, 'Claim accepted after contents matched.', '2026-01-10 16:25:00', '2026-01-17 12:00:00', NULL),
  (4, 'LF-2026-0002', 'lost', 'Apple AirPods', 'Lost white AirPods in a charging case. The case has a small blue sticker on the back and the Bluetooth name includes Sadid.', 1, 'White', 'Apple AirPods 2nd Gen', 'UIU Lab Block B', 'Computer lab corridor bench', '2026-01-11', '11:40:00', NULL, 'active', 2, 19, 1, 'Approved for public listing.', '2026-01-11 12:15:00', '2026-01-11 12:15:00', NULL),
  (5, 'LF-2026-0003', 'lost', 'UIU Hoodie', 'Lost a navy UIU hoodie after prayer break. It has the UIU logo on the chest and a small notebook in one pocket.', 2, 'Navy Blue', 'UIU hoodie', 'UIU Prayer Room', 'Back row near the shoe rack', '2026-01-12', '17:30:00', NULL, 'resolved', 3, 15, 1, 'Marked resolved after finder confirmation.', '2026-01-12 18:05:00', '2026-01-18 09:30:00', NULL),
  (6, 'FF-2026-0003', 'found', 'Keys with Keychain', 'Found a set of three keys with a round UIU keychain. One key has a green plastic cap. Owner must identify the other keychain detail.', 6, 'Silver', NULL, 'UIU Parking Area', 'Near the motorcycle parking row', '2026-01-14', '09:25:00', 'Security desk near parking gate', 'active', 4, 22, 1, 'Approved for public listing.', '2026-01-14 09:50:00', '2026-01-14 09:50:00', NULL),
  (7, 'LF-2026-0004', 'lost', 'Data Structures Book', 'Lost a Data Structures and Algorithms textbook with handwritten notes and highlighted chapters. The first page has my student ID written in pencil.', 7, 'Blue', 'Data Structures and Algorithms in C++', 'Central Library', 'Return shelf beside CSE books', '2026-01-15', '14:00:00', NULL, 'claim_in_progress', 4, 31, 1, 'Claim reviewed but final handover pending.', '2026-01-15 14:30:00', '2026-01-20 11:00:00', NULL),
  (8, 'FF-2026-0004', 'found', 'Prescription Glasses', 'Found prescription glasses in a black hard case. The case was left on a cafeteria chair after the afternoon rush.', 4, 'Black', 'Prescription glasses', 'UIU Cafeteria', 'Chair near the north wall', '2026-01-17', '16:20:00', 'Cafeteria manager desk', 'active', 2, 13, 1, 'Approved for public listing.', '2026-01-17 16:45:00', '2026-01-17 16:45:00', NULL),
  (9, 'LF-2026-0005', 'lost', 'Lab Access Card', 'Lost my lab access card after a CSE lab session. The card has a blue strip and may be inside a transparent card holder.', 5, 'Blue and White', 'UIU Lab access card', 'Computer Lab 401', 'Beside workstation 18', '2026-01-19', '12:50:00', NULL, 'active', 3, 18, 1, 'Approved for public listing.', '2026-01-19 13:10:00', '2026-01-19 13:10:00', NULL),
  (10, 'FF-2026-0005', 'found', 'Green Jacket', 'Found a green jacket after evening class. It has a zipper pocket and a folded class routine paper inside.', 2, 'Green', 'Casual jacket', 'Lecture Hall B-201', 'Back row left corner', '2026-01-21', '18:35:00', 'Lost and found desk', 'resolved', 4, 24, 1, 'Resolved after routine paper was verified.', '2026-01-21 19:00:00', '2026-01-24 10:15:00', NULL),
  (11, 'LF-2026-0006', 'lost', 'Casio Scientific Calculator', 'Submitted for admin review: lost a Casio scientific calculator with a white label on the back. It was last used during a quiz and may have been left on a classroom desk.', 1, 'Black', 'Casio fx-991ES Plus', 'Room 501', 'Front row desk near the projector', '2026-01-25', '10:30:00', NULL, 'awaiting_approval', 2, 0, 0, NULL, '2026-01-25 11:00:00', '2026-01-25 11:00:00', NULL),
  (12, 'LF-2026-0007', 'lost', 'Soft Deleted Item', 'This item has been soft deleted.', 8, 'Unknown', 'Test Brand', 'Test Location', 'Test Spot', '2026-01-26', '12:00:00', NULL, 'active', 2, 0, 1, NULL, '2026-01-26 12:00:00', '2026-01-26 12:30:00', '2026-01-26 12:30:00'),
  (13, 'LF-2026-0008', 'lost', 'Rejected Item', 'This item report was rejected by admin.', 8, 'Unknown', 'Test Brand', 'Test Location', 'Test Spot', '2026-01-26', '12:00:00', NULL, 'rejected', 2, 0, 0, 'Inappropriate content.', '2026-01-26 12:00:00', '2026-01-26 12:30:00', NULL),
  (14, 'FF-2026-0006', 'found', 'Water Bottle', 'Found a blue water bottle.', 8, 'Blue', 'Tupperware', 'Cafeteria', 'On a table', '2026-01-26', '12:00:00', 'Cafeteria desk', 'resolved', 3, 5, 1, 'Resolved.', '2026-01-26 12:00:00', '2026-01-26 13:00:00', NULL);
...
VALUES
  ...
  (4, 14, 2, 'owner', 'It is my blue Tupperware water bottle.', 'I left it in the cafeteria.', 'Cafeteria', 'Anytime', 'resolved', 'Handed over successfully.', '2026-01-26 12:15:00', '2026-01-26 13:00:00');
...
VALUES
  ...
  (11, 3, 'claim_submitted', 'Claim Submitted Successfully', 'Your claim for Water Bottle has been submitted and is pending review.', 1, 14, NULL, '2026-01-26 12:15:00', '2026-01-26 12:15:00');
...
VALUES
  ...
  (6, 1, 'user_banned', 'user', 5, 'Banned for violating policies.', '2026-01-06 10:10:00', '2026-01-06 10:10:00'),
  (7, 1, 'user_unbanned', 'user', 5, 'Temporarily unbanned for testing.', '2026-01-06 10:20:00', '2026-01-06 10:20:00'),
  (8, 1, 'user_banned', 'user', 5, 'Re-banned.', '2026-01-06 10:30:00', '2026-01-06 10:30:00'),
  (9, 1, 'deleted', 'item', 12, 'Soft deleted.', '2026-01-26 12:30:00', '2026-01-26 12:30:00'),
  (10, 1, 'rejected', 'item', 13, 'Inappropriate content.', '2026-01-26 12:30:00', '2026-01-26 12:30:00'),
  (11, 1, 'resolved', 'item', 14, 'Item claimed and resolved.', '2026-01-26 13:00:00', '2026-01-26 13:00:00');
