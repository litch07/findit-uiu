...
INSERT INTO users
  (id, name, email, password, student_id, department, phone, bio, role, is_active, email_verified_at, remember_token, created_at, updated_at)
VALUES
  (1, 'Admin UIU', 'findituiu@gmail.com', '$2y$10$ROV9Iq0iunmpEuqwrSHuke8wZm94IRiXpQ2DSd68sPKlP8tDVv6bK', NULL, 'Administration', '+8801700000000', 'FindIt portal administrator responsible for report review and moderation.', 'admin', 1, '2026-01-01 09:00:00', NULL, '2026-01-01 09:00:00', '2026-01-01 09:00:00'),
  (2, 'Sadid Ahmed', 'sahmed2330154@bscse.uiu.ac.bd', '$2y$10$SXPdsUJt/1M9FC7HzMnEyOMNsMXm3QkZsC9rlufA6hZ9JGWoEuADa', '0112330154', 'BSc in Computer Science and Engineering', '+8801811111111', 'CSE student at UIU. Usually around the lab block and library.', 'student', 1, '2026-01-03 10:00:00', NULL, '2026-01-03 10:00:00', '2026-01-03 10:00:00'),
  (3, 'M.M. Sayem Prodhan', 'mprodhan2330411@bscse.uiu.ac.bd', '$2y$10$SXPdsUJt/1M9FC7HzMnEyOMNsMXm3QkZsC9rlufA6hZ9JGWoEuADa', '0112330411', 'BSc in Computer Science and Engineering', '+8801822222222', 'CSE student. Often attends classes in lecture halls and the library.', 'student', 1, '2026-01-04 11:00:00', NULL, '2026-01-04 11:00:00', '2026-01-04 11:00:00'),
  (4, 'Md. Assaduzzaman Nur', 'mnur2230442@bscse.uiu.ac.bd', '$2y$10$SXPdsUJt/1M9FC7HzMnEyOMNsMXm3QkZsC9rlufA6hZ9JGWoEuADa', '0112230442', 'BSc in Computer Science and Engineering', '+8801833333333', 'UIU CSE student and FindIt tester. Usually around cafeteria and parking area.', 'student', 1, '2026-01-05 12:00:00', NULL, '2026-01-05 12:00:00', '2026-01-05 12:00:00');
...
INSERT INTO items
  (id, type, title, description, category_id, color, brand_model, location, specific_spot, lost_found_date, lost_found_time, current_location, status, posted_by, view_count, is_approved, admin_note, reference_id, created_at, updated_at)
VALUES
  (1, 'lost', 'Samsung Galaxy Phone', 'Lost a Samsung Galaxy phone with a matte black case. The lock screen has a photo from the UIU courtyard. It may have been left on a reading table after group study.', 1, 'Black', 'Samsung Galaxy S23', 'UIU Library 2nd Floor', 'Reading table near the east window', '2026-01-08', '15:20:00', NULL, 'active', 2, 34, 1, 'Approved for public listing.', 'LF-2026-0001', '2026-01-08 15:45:00', '2026-01-08 15:45:00'),
  (2, 'found', 'UIU Student ID Card', 'Found a UIU student ID card after lunch. The card is safe and can be verified by name, student ID, and department before handover.', 5, 'White', NULL, 'UIU Cafeteria', 'Table beside the juice counter', '2026-01-09', '13:10:00', 'Cafeteria service counter', 'resolved', 3, 27, 1, 'Resolved after owner verification.', 'FF-2026-0001', '2026-01-09 13:35:00', '2026-01-13 10:20:00'),
  (3, 'found', 'Black Wallet', 'Found a black leather wallet containing several cards and receipts. No cash amount will be disclosed publicly; owner must describe contents for verification.', 4, 'Black', 'Leather bi-fold wallet', 'Lecture Hall 302', 'Under the third row desk', '2026-01-10', '16:00:00', 'Department office front desk', 'claim_in_progress', 4, 42, 1, 'Claim accepted after contents matched.', 'FF-2026-0002', '2026-01-10 16:25:00', '2026-01-17 12:00:00'),
  (4, 'lost', 'Apple AirPods', 'Lost white AirPods in a charging case. The case has a small blue sticker on the back and the Bluetooth name includes Sadid.', 1, 'White', 'Apple AirPods 2nd Gen', 'UIU Lab Block B', 'Computer lab corridor bench', '2026-01-11', '11:40:00', NULL, 'active', 2, 19, 1, 'Approved for public listing.', 'LF-2026-0002', '2026-01-11 12:15:00', '2026-01-11 12:15:00'),
  (5, 'lost', 'UIU Hoodie', 'Lost a navy UIU hoodie after prayer break. It has the UIU logo on the chest and a small notebook in one pocket.', 2, 'Navy Blue', 'UIU hoodie', 'UIU Prayer Room', 'Back row near the shoe rack', '2026-01-12', '17:30:00', NULL, 'resolved', 3, 15, 1, 'Marked resolved after finder confirmation.', 'LF-2026-0003', '2026-01-12 18:05:00', '2026-01-18 09:30:00'),
  (6, 'found', 'Keys with Keychain', 'Found a set of three keys with a round UIU keychain. One key has a green plastic cap. Owner must identify the other keychain detail.', 6, 'Silver', NULL, 'UIU Parking Area', 'Near the motorcycle parking row', '2026-01-14', '09:25:00', 'Security desk near parking gate', 'active', 4, 22, 1, 'Approved for public listing.', 'FF-2026-0003', '2026-01-14 09:50:00', '2026-01-14 09:50:00'),
  (7, 'lost', 'Data Structures Book', 'Lost a Data Structures and Algorithms textbook with handwritten notes and highlighted chapters. The first page has my student ID written in pencil.', 7, 'Blue', 'Data Structures and Algorithms in C++', 'Central Library', 'Return shelf beside CSE books', '2026-01-15', '14:00:00', NULL, 'claim_in_progress', 4, 31, 1, 'Claim reviewed but final handover pending.', 'LF-2026-0004', '2026-01-15 14:30:00', '2026-01-20 11:00:00'),
  (8, 'found', 'Prescription Glasses', 'Found prescription glasses in a black hard case. The case was left on a cafeteria chair after the afternoon rush.', 4, 'Black', 'Prescription glasses', 'UIU Cafeteria', 'Chair near the north wall', '2026-01-17', '16:20:00', 'Cafeteria manager desk', 'active', 2, 13, 1, 'Approved for public listing.', 'FF-2026-0004', '2026-01-17 16:45:00', '2026-01-17 16:45:00'),
  (9, 'lost', 'Lab Access Card', 'Lost my lab access card after a CSE lab session. The card has a blue strip and may be inside a transparent card holder.', 5, 'Blue and White', 'UIU Lab access card', 'Computer Lab 401', 'Beside workstation 18', '2026-01-19', '12:50:00', NULL, 'active', 3, 18, 1, 'Approved for public listing.', 'LF-2026-0005', '2026-01-19 13:10:00', '2026-01-19 13:10:00'),
  (10, 'found', 'Green Jacket', 'Found a green jacket after evening class. It has a zipper pocket and a folded class routine paper inside.', 2, 'Green', 'Casual jacket', 'Lecture Hall B-201', 'Back row left corner', '2026-01-21', '18:35:00', 'Lost and found desk', 'resolved', 4, 24, 1, 'Resolved after routine paper was verified.', 'FF-2026-0005', '2026-01-21 19:00:00', '2026-01-24 10:15:00'),
  (11, 'lost', 'Casio Scientific Calculator', 'Submitted for admin review: lost a Casio scientific calculator with a white label on the back. It was last used during a quiz and may have been left on a classroom desk.', 1, 'Black', 'Casio fx-991ES Plus', 'Room 501', 'Front row desk near the projector', '2026-01-25', '10:30:00', NULL, 'awaiting_approval', 2, 0, 0, NULL, 'LF-2026-0006', '2026-01-25 11:00:00', '2026-01-25 11:00:00');
...
INSERT INTO conversations (id, item_id, participant_one, participant_two, last_activity, created_at, updated_at) VALUES
  (1, 1, 2, 3, '2026-01-09 16:45:00', '2026-01-09 10:30:00', '2026-01-09 16:45:00'),
  (2, 3, 2, 4, '2026-01-11 14:10:00', '2026-01-11 09:45:00', '2026-01-11 14:10:00');

INSERT INTO messages (id, conversation_id, sender_id, body, is_read, created_at, updated_at) VALUES
  (1, 1, 3, 'Hi Sadid, I saw your Samsung phone report. I found one on the library 2nd floor today.', 1, '2026-01-09 10:30:00', '2026-01-09 10:30:00'),
  (2, 1, 2, 'Thanks Sayem. Does it have a matte black case and a courtyard photo on the lock screen?', 1, '2026-01-09 10:42:00', '2026-01-09 10:42:00'),
  (3, 1, 3, 'Yes, exactly. I left it with the library help desk so it stays safe.', 1, '2026-01-09 10:55:00', '2026-01-09 10:55:00'),
  (4, 1, 2, 'I can come after my 2 PM class with my student ID and unlock it in front of you.', 1, '2026-01-09 11:08:00', '2026-01-09 11:08:00'),
  (5, 1, 3, 'Great. I will be near the library desk around 4:45 PM.', 0, '2026-01-09 16:45:00', '2026-01-09 16:45:00'),
  (6, 2, 2, 'Assaduzzaman, I saw your black wallet found post. I think it might be mine from Lecture Hall 302.', 1, '2026-01-11 09:45:00', '2026-01-11 09:45:00'),
  (7, 2, 4, 'Can you describe two things inside it? I kept it with the department office.', 1, '2026-01-11 10:05:00', '2026-01-11 10:05:00'),
  (8, 2, 2, 'It has my UIU ID card and a folded bus ticket. There should also be a bKash receipt.', 1, '2026-01-11 10:18:00', '2026-01-11 10:18:00'),
  (9, 2, 4, 'That matches. Please come to the Lecture Hall 302 entrance around 2:15 PM and bring your ID.', 0, '2026-01-11 14:10:00', '2026-01-11 14:10:00');

INSERT INTO notifications
  (id, user_id, type, title, message, is_read, related_item_id, created_at, updated_at)
VALUES
  (1, 2, 'claim_request', 'New Claim Request', 'M.M. Sayem Prodhan submitted a claim update for your lost Samsung Galaxy Phone.', 0, 1, '2026-01-09 10:16:00', '2026-01-09 10:16:00'),
  (2, 2, 'message', 'New Message Received', 'M.M. Sayem Prodhan messaged you about the Samsung phone recovery.', 0, 1, '2026-01-09 16:45:00', '2026-01-09 16:45:00'),
  (3, 2, 'claim_accepted', 'Claim Accepted', 'Your claim for the Black Wallet was accepted. Please coordinate pickup with the finder.', 1, 3, '2026-01-12 15:05:00', '2026-01-12 15:05:00'),
  (4, 3, 'claim_request', 'New Claim Request', 'A student responded to your UIU Student ID Card report and requested verification.', 0, 2, '2026-01-10 09:20:00', '2026-01-10 09:20:00'),
  (5, 3, 'claim_rejected', 'Claim Rejected', 'Your claim for the Data Structures Book was rejected because the verification details did not match.', 1, 7, '2026-01-17 12:12:00', '2026-01-17 12:12:00'),
  (6, 1, 'new_report', 'New Report Submitted', 'Sadid Ahmed posted a lost report: Samsung Galaxy Phone.', 0, 1, '2026-01-08 15:46:00', '2026-01-08 15:46:00'),
  (7, 1, 'new_report', 'New Report Submitted', 'Md. Assaduzzaman Nur posted a found report: Black Wallet.', 0, 3, '2026-01-10 16:26:00', '2026-01-10 16:26:00'),
  (8, 1, 'new_user', 'New Student Registered', 'M.M. Sayem Prodhan completed registration with a UIU student email.', 1, NULL, '2026-01-04 11:02:00', '2026-01-04 11:02:00'),
  (9, 1, 'new_report', 'New Report Submitted', 'Sadid Ahmed posted a lost report: Casio Scientific Calculator.', 0, 11, '2026-01-25 11:01:00', '2026-01-25 11:01:00'),
  (10, 4, 'found_report', 'Someone May Have Found Your Item!', 'M.M. Sayem Prodhan says they may have found your "Data Structures Book"', 0, 7, '2026-01-16 10:21:00', '2026-01-16 10:21:00');
