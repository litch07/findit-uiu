...
INSERT INTO items
  (id, display_id, type, title, description, category_id, color, brand_model, location, specific_spot, lost_found_date, lost_found_time, current_location, status, posted_by, view_count, is_approved, admin_note, created_at, updated_at)
VALUES
  (1, 'LF-2026-0001', 'lost', 'Samsung Galaxy Phone', 'Lost a Samsung Galaxy phone with a matte black case. The lock screen has a photo from the UIU courtyard. It may have been left on a reading table after group study.', 1, 'Black', 'Samsung Galaxy S23', 'UIU Library 2nd Floor', 'Reading table near the east window', '2026-01-08', '15:20:00', NULL, 'active', 2, 34, 1, 'Approved for public listing.', '2026-01-08 15:45:00', '2026-01-08 15:45:00'),
