...
CREATE TABLE users (
  ...
  is_banned TINYINT(1) NOT NULL DEFAULT 0, -- Added: is_banned -- account suspension flag used by banUser/unbanUser and CheckBanned middleware
...
CREATE TABLE items (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  display_id VARCHAR(30) NULL DEFAULT NULL, -- Added: display_id -- human-readable reference (e.g. L-2024-0001); generated by Item::generateDisplayId(), searched by AdminController
